...
def compute_metrics_for_sample(
    ...
    if clip_with_visibility:
        ...
        visibility_aggregator = VisibilityAggregator(volume=visibility_volume, additional_extent=0.1)
    ...
    # compute metrics
    metrics, distances_pred2gt, distances_gt2pred = compute_point_cloud_metrics(gt_o3d_pcd, pred_o3d_pcd, visible_pred_indices=visible_pred_indices)
