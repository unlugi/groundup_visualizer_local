...
# Read the PNG image
data_folder = "data/"
filename_sketch = "rgb_10001.png0001"
...
for i in range(len(contours)):
    ...
    if True: # hierarchy[i][3] != -1: # skip the root parent contour and get the first child
        ...
        # TODO: don't forget to add the first parent. hierarchy[i]

        # Get child
        current_child_index = hierarchy[i][2] # TODO: is this inner contour of i or outer contour of first child?
...
for i, colored_mask in enumerate(colored_masks):
    ...
    merged_mask[colored_mask > 0] = mean_depth[i] * 100
